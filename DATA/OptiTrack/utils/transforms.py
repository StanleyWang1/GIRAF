...
# ROBOT + TRIALS
# CUSTOM_T[:3, 3] = np.array([0.044, 0.193, -0.035])

# HUMAN OPERATOR -> ROBOT
# CUSTOM_T[:3, 3] = np.array([0.0115, 0.065, -0.037])
# 0.00513     0.01304    -0.004846

CUSTOM_T[:3, 3] = np.array([0.0115-0.0045+0.00513-0.00107, 0.065+0.003+0.01304-0.000145, -0.037+0.0724-0.004846+0.0029])
# diffs = [-0.0045, 0.003, 0.0724]
